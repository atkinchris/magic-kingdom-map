...
var SIZE_UNIT = 8;
var mapData = [{ type: 'endcap', x: 100, y: 100 }, { type: 'stop', x: 100, y: 150, orientation: 'left' }, { type: 'stop', x: 100, y: 200 }, { type: 'point', x: 100, y: 250 }, { type: 'corner', x: 100, y: 300 }, { type: 'stop', x: 150, y: 300, orientation: 'up' }, { type: 'stop', x: 200, y: 300, orientation: 'down' }, { type: 'endcap', x: 250, y: 300, orientation: 'vertical' }];

var buildEndCap = function buildEndCap(map, x, y) {
  var orientation = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'horizontal';

  var endCap = map.rect(SIZE_UNIT * 2, SIZE_UNIT).move(x - SIZE_UNIT, y - SIZE_UNIT / 2);
...
var buildStop = function buildStop(map, x, y) {
  var orientation = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'right';

  var stop = map.rect(SIZE_UNIT * 2, SIZE_UNIT).move(x, y);
...
var buildMap = function buildMap() {
  var map = (0, _svg2.default)('map');

  var linePoints = [];

  mapData.forEach(function (_ref, index, arr) {
    var type = _ref.type,
        x = _ref.x,
        y = _ref.y,
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.85ae754c.js.map