...
var _lines = __webpack_require__("./src/data/lines.js");
...
var _water = __webpack_require__("./src/data/water.js");
...
var _extras = __webpack_require__("./src/data/extras.js");
...
exports.default = [[[-33, -36], [-12, -36], [-12, 15], [-33, 15], [-33, -10], [-55, -10, true], [-55, -17, true], [-33, -17], [-33, -36]], [[-40, 55], [0, 55], [0, 25], [20, 25], [20, 0], [41, 0], [41, 20], [36, 20], [36, 16], [36, 5], [25, 5], [25, 30], [5, 30], [5, 60], [-40, 60], [-40, 55]]];

/***/ }),

/***/ "./src/elements/endCap.js":
/***/ (function(module, exports, __webpack_require__) {
...
exports.buildSaveButton = exports.buildLegend = exports.buildExtra = exports.buildWater = exports.buildLine = exports.buildStation = exports.buildEndCap = exports.buildStop = undefined;

var _stop = __webpack_require__("./src/elements/stop.js");

var _stop2 = _interopRequireDefault(_stop);

var _endCap = __webpack_require__("./src/elements/endCap.js");

var _endCap2 = _interopRequireDefault(_endCap);

var _station = __webpack_require__("./src/elements/station.js");

var _station2 = _interopRequireDefault(_station);

var _line = __webpack_require__("./src/elements/line.js");

var _line2 = _interopRequireDefault(_line);

var _water = __webpack_require__("./src/elements/water.js");

var _water2 = _interopRequireDefault(_water);

var _extra = __webpack_require__("./src/elements/extra.js");

var _extra2 = _interopRequireDefault(_extra);

var _legend = __webpack_require__("./src/elements/legend.js");

var _legend2 = _interopRequireDefault(_legend);

var _saveButton = __webpack_require__("./src/elements/saveButton.js");
...
exports.buildSaveButton = _saveButton2.default;
...
var buildLegend = function buildLegend(svg, legend, position) {
  var group = svg.group();
  var x = position.x,
      y = position.y;
  ...
  var _group$bbox = group.bbox(),
      width = _group$bbox.width,
      height = _group$bbox.height;

  group.move(Math.floor(x - width), Math.floor(y - height));
  group.dy(_constants.SIZE_UNIT * 4);
  group.dx(-_constants.SIZE_UNIT * 8);
};
...
var _ = __webpack_require__("./src/elements/index.js");
...
var _saveSvgAsPng = __webpack_require__("./node_modules/save-svg-as-png/saveSvgAsPng.js");

var buildSaveButton = function buildSaveButton(svg) {
  var options = {
    backgroundColor: 'white',
    scale: 4
  };
  var onClick = function onClick() {
    return (0, _saveSvgAsPng.saveSvgAsPng)(svg.node, 'map.png', options);
  };

  document.getElementById('save-button').onclick = onClick;
};

exports.default = buildSaveButton;

/***/ }),

/***/ "./src/elements/station.js":
/***/ (function(module, exports, __webpack_require__) {
...
var buildStop = function buildStop(group, point, color) {
  ...
  switch (orientation) {
    case 'right':
      stop.dx(-_constants.SIZE_UNIT / 2);
      break;
    case 'left':
      stop.dx(-_constants.SIZE_UNIT / 2).rotate(180, x);
      break;
    case 'up':
      stop.dy(-_constants.SIZE_UNIT / 2).rotate(-90, x, y + _constants.SIZE_UNIT / 2);
      break;
    case 'down':
      stop.dy(-_constants.SIZE_UNIT / 2).rotate(90, x, y - _constants.SIZE_UNIT / 2);
      break;
...
var buildWater = function buildWater(map, rawPoints) {
  var points = rawPoints.map(function (_ref) {
    ...
    return [x * _constants.SIZE_UNIT, y * _constants.SIZE_UNIT, hard];
  });
...
var _svg = __webpack_require__("./node_modules/svg.js/dist/svg.js");
...
var _map$bbox = map.bbox(),
    x = _map$bbox.x,
    y = _map$bbox.y,
    width = _map$bbox.width,
    height = _map$bbox.height;

map.dmove(-x + _constants.SIZE_UNIT, -y + _constants.SIZE_UNIT * 2);
svg.size(width + _constants.SIZE_UNIT * 2, height + _constants.SIZE_UNIT * 4);

(0, _elements.buildLegend)(svg, legend, { x: width, y: height });
(0, _elements.buildSaveButton)(svg);

/***/ })

/******/ });
//# sourceMappingURL=main.23c8f854.js.map